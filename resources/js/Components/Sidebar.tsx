...
export default function Sidebar(){
    ...
    return (
        <div className="md:w-1/4 lg:w-1/5 min-h-[90vh] h-full bg-white p-4 min-w-[240px] text-gray-600 flex flex-col justify-between items-center">
            ...
            <PrimaryButton>
                <Link className="flex gap-4">Archive <RiArchiveStackFill className="text-lg" /></Link>
            </PrimaryButton>
        </div>
    );
}
